...
return [
    ...
    'timestamp' => 1727984642,
    'checksum' => 'e0700a189d36a472381d64f3bc5ff3af',
    'files' => [
        'user/config' => [
            'media' => [
        ...
        'user/themes' => [
            'themes/reckner-facilities' => [
                'file' => 'user/themes/reckner-facilities/reckner-facilities.yaml',
                'modified' => 1727984634
            ]
        ]
    ],
    'data' => [
        ...
        'plugins' => [
            ...
            'svg-icons' => [
                'enabled' => true,
                'custom_icon_path' => 'theme://images/icons'
            ],
            'form' => [
                'enabled' => true,
                'built_in_css' => false,
                ...
                'recaptcha' => [
                    'version' => 3,
                    'theme' => 'light',
                    'site_key' => '6LcOpDsqAAAAAMkDqMm1TZtdzAb34sW8cedRrO8e',
                    'secret_key' => '6LcOpDsqAAAAADBLazt0aFfuxE7t9T-u1MyiSk3D'
                ],
                'turnstile' => [
                    'theme' => 'light',
                    'site_key' => NULL,
...
node_modules'
        ...
        'site' => [
            ...
            'redirects' => [
                '/fast-quote' => '/quick-quote'
            ],
            'routes' => NULL,
            'blog' => [
                'route' => '/blog'
            ],
            'footer' => 'Copyright © 2018 - %%YEAR%% - Reckner Associates, Inc. - All rights reserved.
'
        ],
        'system' => [
            'absolute_urls' => false,
